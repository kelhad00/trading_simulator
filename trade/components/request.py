...
#             lambda x: tls[dash_registry['lang']]['request-action']['choices'][0]['label'] if x == 'buy' else
#             tls[dash_registry['lang']]['request-action']['choices'][1]['label'])
#         df.rename(columns={
...
#         }, inplace=True)
#
#     return req, no_update, dmc.Table(
...
#     if not df.empty:
#         # replace all the 'buy' and 'sell' by their translated version
#         df['action'] = df['action'].apply(lambda x: tls[dash_registry['lang']]['request-action']['choices'][0]['label'] if x == 'buy' else tls[dash_registry['lang']]['request-action']['choices'][1]['label'])
#         df.rename(columns={
#             'action': tls[dash_registry['lang']]['requests-table']['actions'],
#             'shares': tls[dash_registry['lang']]['requests-table']['shares'],
#             'company': tls[dash_registry['lang']]['requests-table']['company'],
