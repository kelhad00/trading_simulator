translation = {
    'fr' : {
        ...
        'portfolio-columns': {'Stock': 'Actions', 'Shares': 'Parts', 'Total': 'Totals'},
        ...
        # Request form
        "request-title": "Faites une requête",
        "request-action": {
            "label": "Action",
        ...
        # Requests list
        "requests-list-title": "Liste des requêtes",
        "requests-table": {
            "actions": "Actions",
            "shares": "Parts",
            "company": "Compagnie",
        ...
        # Home Page
        "welcome": "Bienvenue sur l\'app TradeSim !",
