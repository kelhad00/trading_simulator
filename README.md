...
* `Tailwind CSS` is used for the styling of the application. ([https://tailwindcss.com/](https://tailwindcss.com/))
* `Dash Mantine Components` is used for the visual components. (version 1.12) ([https://dmc-docs-0-12.onrender.com/](https://dmc-docs-0-12.onrender.com/))
...
* `graph` : all the callbacks related to the graph (market\_data and revenue)
...
Settings is divided in 7 sections :

* `charts` : all the callbacks related to the charts and their generation
* `pattern` : all the callbacks related to the patterns and their generation
...
* Add the possibility to use real market data
* Add a selection of pre-made scenario
* Improve news generation speed and caching
